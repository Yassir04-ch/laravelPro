    ...
    <div class="w-full max-w-md bg-white rounded-[2.5rem] shadow-xl border border-slate-100 p-8 md:p-10 relative overflow-hidden">
        ...
        <form action="{{ route('category.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative group">
                    <input type="text" id="name" name="name" required
                        class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-50 focus:border-emerald-500 transition-all text-slate-900 font-semibold placeholder:font-normal placeholder:text-slate-400"
            ...
            <div class="grid grid-cols-2 gap-4 pt-2">
                <a href="/category/index" class="flex items-center justify-center py-4 bg-slate-100 text-slate-600 font-bold rounded-2xl hover:bg-slate-200 transition-all text-sm">
                    Cancel
                </a>
                <button type="submit" 
